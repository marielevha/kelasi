                            ...
                            <div class="topbar-item mr-3">
                                <div class="btn btn-icon w-auto btn-clean d-inline-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                    ...
                                    <span class="symbol symbol-35 symbol-light-info">
                                        <span class="symbol-label font-size-h5 font-weight-bold">{{  Str::upper(Str::substr(Auth::user()->name, 0, 2)) }}</span>
                                    </span>
                                </div>
                            </div>
                            <!--end::User-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    <a href="{{ route('commercial.account.index') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{  Str::ucfirst(Auth::user()->name) }}</a>
                    <div class="text-muted mt-1">{{ Str::ucfirst(Str::lower(Auth::user()->profile)) }}</div>
                    <div class="navi mt-1">
                        <a href="{{ route('commercial.account.index') }}" class="navi-item">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                ...
                <a href="{{ route('commercial.account.index') }}" class="navi-item">
                    <div class="navi-link">
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">{{ __('My Account') }}</div>
                ...
                <!--begin::Item-->
                <a href="{{ route('commercial.settings.index') }}" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
								<span class="svg-icon svg-icon-xl svg-icon-danger">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-21-040700/theme/demo6/dist/../src/media/svg/icons/Code/Settings4.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">{{ __('Settings') }}</div>
                            <div class="text-muted">{{ __('Customizing Settings') }}</div>
                        </div>
                    </div>
                </a>
                <!--end:Item-->
