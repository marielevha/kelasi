<x-guest-layout>
    ...
    <x-slot name="title">{{ __('reset-password.title') }}</x-slot>

    <x-slot name="local_link">

        <!--begin::Page Custom Styles(used by this page)-->
        <link href="https://preview.keenthemes.com/keen/theme/demo6/dist/assets/css/pages/login/login-1.css?v=2.1.1"
    ...
    <x-slot name="local_script">
        ...
        <script
            src="https://preview.keenthemes.com/keen/theme/demo6/dist/assets/js/pages/custom/login/login.js?v=2.1.1"></script>
        <!--end::Page Scripts-->
        ...
        <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white">
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #7EBFDB;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <!--end::Aside header-->
                    <!--begin::Aside title-->
                    <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg text-white">{{ __('reset-password.aside_subheader_1')}}
                        <br/>{{ __('reset-password.aside_subheader_2') }}
                    </h3>
                    <!--end::Aside title-->
                </div>
                <!--end::Aside Top-->
                    ...
                    <div class="login-form login-signin">
                        ...
                        <!-- Password Reset Token -->
                            ...
                            <div class="pb-13 pt-lg-0 pt-5">
                                ...
                                <span
                                    class="text-muted font-weight-bold font-size-h4">{{ __('reset-password.enter_credentials_login') }}</span>
                            </div>
                            <!--begin::Title-->
                            ...
                            <div class="form-group">
                                <label for="email"
                                       class="font-size-h6 font-weight-bolder text-dark">{{ __('reset-password.email') }}</label>
                                <input
                                    id="email"
                            ...
                            <div class="form-group">
                                <label for="password"
                                       class="font-size-h6 font-weight-bolder text-dark pt-5">{{ __('reset-password.password') }}</label>
                                <input
                                    id="password"
                                    class="form-control form-control-solid h-auto p-6 rounded-lg"
                                    type="password"
...
{{--                                    pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[]:;<>,.?/~_+-=|\]).{8,32}$"--}}
                            ...
                            <div class="form-group">
                                <label for="password_confirmation"
                                       class="font-size-h6 font-weight-bolder text-dark">{{ __('reset-password.password_confirm') }}</label>
                                <input
                                    ...
                                    required
                                    placeholder="{{ __('validation.attributes.password-confirm-placeholder') }}"
{{--                                    pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[]:;<>,.?/~_+-=|\]).{8,32}$"--}}
                                    title="{{ __('validation.placeholder-title-pattern-password') }}"
                                    tabindex="3"
                                />
                            ...
                            <div class="pb-lg-0 pb-5">
                                ...
                                <a href="{{ route('login') }}" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4">{{ __('cancel') }}</a>
                ...
                <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                    <a href="#" class="text-primary font-weight-bolder font-size-h5">{{ __('reset-password.terms') }}</a>
                    <a href="#" class="text-primary ml-10 font-weight-bolder font-size-h5">{{ __('reset-password.plans') }}</a>
                    <a href="#"
                       class="text-primary ml-10 font-weight-bolder font-size-h5">{{ __('reset-password.contact_us') }}</a>
                </div>
                <!--end::Content footer-->
            </div>
            <!--end::Content-->
