...
@section('locale_styles')
    <link href="https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/css/pages/login/login-3.css?v=2.1.1" rel="stylesheet" type="text/css" />
@endsection
        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            <div class="d-flex flex-column-auto flex-column pt-15 px-30">
                <a href="#" class="login-logo py-6">
                    <img src="https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/media/logos/logo-6.svg" alt="logo" class="h-60px" />
                </a>
                <div class="wizard-nav py-12 mb-10">
            ...
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
            <div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-size-contain" style="background-image: url(https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/media/svg/illustrations/accomplishment.svg)"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
                    ...
                    <form class="form" novalidate="novalidate" id="kt_login_signup_form">
                        ...
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="pb-10 pb-lg-15">
                                ...
                                <div class="text-muted font-weight-bold font-size-h4">Already have an Account ?
                                    <a href="https://preview.keenthemes.com/keen-v2/demo6/custom/pages/login/login-3/signin.html" class="text-primary font-weight-bolder">Sign In</a></div>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">First Name</label>
                                <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="fname" placeholder="First Name" value="" />
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Last Name</label>
                                <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="lname" placeholder="Last Name" value="" />
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Phone</label>
                                <input type="tel" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="phone" placeholder="phone" value="+61412345678" />
                            </div>
                            <!--end::Form Group-->
                        </div>
                        <!--end: Wizard Step 1-->
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="address1" placeholder="Address Line 1" value="Address Line 1" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="address2" placeholder="Address Line 2" value="Address Line 2" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="postcode" placeholder="Postcode" value="3000" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="city" placeholder="City" value="Melbourne" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" name="state" placeholder="State" value="VIC" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="country" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6">
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="form-group">
                                ...
                                <select name="delivery" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="packaging" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="preferreddelivery" class="form-control h-auto py-6 border-0 rounded-lg font-size-h6">
                            ...
                            <div class="mr-2">
                                <button type="button" class="btn btn-light-primary font-weight-bolder font-size-h6 pl-6 pr-8 py-4 my-3 mr-3" data-wizard-type="action-prev">
										<span class="svg-icon svg-icon-md mr-1">
											<!--begin::Svg Icon | path:https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/media/svg/icons/Navigation/Left-2.svg-->
                            ...
                            <div>
                                <button class="btn btn-primary font-weight-bolder font-size-h6 pl-5 pr-8 py-4 my-3" data-wizard-type="action-submit" type="submit" id="kt_login_signup_form_submit_button">Submit
                                    <span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
...
@section('locale_scripts')
    <script src="https://preview.keenthemes.com/keen-v2/theme/demo6/dist/assets/js/pages/custom/login/login-3.js?v=2.1.1"></script>
@endsection
{{--
<x-guest-layout>
    <x-auth-card>
