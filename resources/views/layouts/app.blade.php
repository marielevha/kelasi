...
{{--	<link href="https://preview.keenthemes.com/keen/theme/demo6/dist/assets/css/style.bundle.css?v=2.1.1" rel="stylesheet" type="text/css" />--}}
    ...
    <link href="{{ asset('plugins/global/plugins.bundlee8da.css?v=2.0.3') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('plugins/custom/prismjs/prismjs.bundlee8da.css?v=2.0.3') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('css/style.bundlee8da.css?v=2.0.3') }}" rel="stylesheet" type="text/css"/>
...
{{--	<script src="https://preview.keenthemes.com/keen/theme/demo6/dist/assets/js/scripts.bundle.js?v=2.1.1"></script>--}}
    ...
    <script src="{{ asset('plugins/global/plugins.bundlee8da.js?v=2.0.3') }}"></script>
    <script src="{{ asset('plugins/custom/prismjs/prismjs.bundlee8da.js?v=2.0.3') }}"></script>
    <script src="{{ asset('js/scripts.bundlee8da.js?v=2.0.3') }}"></script>
