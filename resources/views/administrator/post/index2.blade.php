<x-dashboard-administrator>
    ...
    <div class="d-block display-once">
        ...
        <div class="tab-content" id="myTabTable4">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mr-7">
                                    <div class="symbol symbol-50 symbol-lg-120 {!! $class_light[random_int(1, 4)] !!}">
                                        ...
                                        <span class="font-size-h3 symbol-label font-weight-boldest">PText</span>
                                    </div>
                                </div>
                                <!--end::Pic-->
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                        ...
                                        <div class="mr-3">
                                            ...
                                            <a href="{{ route('post.edit', ['id' => $post->id]) }}" class="d-flex align-items-center text-dark text-hover-primary font-size-h3 font-weight-bolder mr-3">
                                                ...
                                                PText <span class="text-muted text-hover-primary font-size-lg pl-3"> PText</span>
                                            </a>
                                            <!--end::Name-->
                                            <!--begin::Contacts-->
            ...
            @forelse($listOfNewTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
            ...
            @forelse($listOfQueuedTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
            ...
            @forelse($listOfInProgressTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
            ...
            @forelse($listOfPendingTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
            ...
            @forelse($listOfResolvedTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
            ...
            @forelse($listOfClosedTickets as $post)
                <!--begin::Card-->
                <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                    <div class="card-body">
                        <!--begin::Top-->
