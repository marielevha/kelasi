        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">{{ __('List Of Organization Posts') }} <span class="text-muted ml-3 font-weight-bold font-size-lg">{{ trans('This organization currently has :number tickets', ['number' => count($listOfTickets)]) }}</span></span>
                </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                        ...
                                        <div class="mr-3">
                                            <!--begin::Name-->
                                            <a href="{{ route('post.edit', ['id' => $ticket->id]) }}" class="d-flex align-items-center text-dark text-hover-primary font-size-h3 font-weight-bolder mr-3">
                                                ...
                                                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Status : NEW') }}" data-placement="top">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right p-0 m-0">
                                                        ...
                                                        <ul class="navi navi-hover py-3">
                                                            <li class="navi-item">
                                                                <a href="{{ route('post.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'QUEUED']) }}" class="navi-link px-5 font-weight-bold">
                                                                    <span class="navi-text">{{ __('QUEUED') }}</span>
                                                                </a>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="{{ route('post.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'INPROG']) }}" class="navi-link px-5 font-weight-bold">
                                                                    <span class="navi-text">{{ __('IN PROGRESS') }}</span>
                                                                </a>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="{{ route('post.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'PENDING']) }}" class="navi-link px-5 font-weight-bold">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="{{ route('post.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'RESOLVED']) }}" class="navi-link px-5 font-weight-bold">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="{{ route('post.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'CLOSED']) }}" class="navi-link px-5 font-weight-bold">
                        ...
                        <tr>
                            ...
                            <td class="p-0">
                                <div class="text-right">
                                    <a href="{{ route('post.edit', ['id' => $ticket->id]) }}" class="btn btn-icon btn-light-primary m-1">
                                    ...
                                    @if(!$ticket->deletedAt)
                                        <a href="{{ route('post.disable.id', ['id' => $ticket->id, 'code' => $ticket->code]) }}" onclick="return confirm('{{ __('post.infos.ticket-are-you-sure-disable', ['code' => $ticket->code]) }}')" class="btn btn-icon btn-danger m-1">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-21-040700/theme/demo6/dist/../src/media/svg/icons/Home/Trash.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
