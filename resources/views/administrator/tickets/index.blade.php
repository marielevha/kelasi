    ...
    <x-slot name="subheader">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">{!! trans('commercial-tickets.title') !!}</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
        ...
        <div class="d-flex align-items-center flex-wrap">
            <!--begin::Dropdown-->
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Add New Tickets') }}" data-placement="bottom">
                <a href="{{ route('ticket.create') }}" class="btn btn-light-primary font-weight-bolder px-5 mr-3 my-1">
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Tasks Actions') }}" data-placement="top">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right p-0 m-0">
                    ...
                    <ul class="navi navi-hover">
                        <li class="navi-item">
                            <a href="{{ route('task.create') }}" class="navi-link px-5 py-5 font-weight-bold">
                        ...
                        <li class="navi-item">
                            <a href="{{ route('tasks.index') }}" class="navi-link px-5 py-5 font-weight-bold">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">{{ __('List Of Organization Tickets') }} <span class="text-muted ml-3 font-weight-bold font-size-lg">{{ trans('This organization currently has :number tickets', ['number' => count($listOfTickets)]) }}</span></span>
                </div>
                ...
                <div class="card-toolbar">
                    <ul class="nav nav-bold nav-pills nav-pills-sm nav-dark">
                        <li class="nav-item" data-toggle="tooltip" title="{{ __('List Of All Tickets') }}" data-placement="left">
                            <a class="nav-link active font-weight-bold font-size-md" data-toggle="tab" href="#kt_tab_table_4_7">{{ __('All Tickets') }}</a>
                        </li>
...
{{--            ALL TICKETS--}}
            <div class="tab-pane fade show active" id="kt_tab_table_4_7" role="tabpanel" aria-labelledby="kt_tab_table_4_7">
                @forelse($listOfTickets as $ticket)
                    <!--begin::Card-->
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mr-7">
                                    <div class="symbol symbol-50 symbol-lg-120 {!! $class_light[random_int(1, 4)] !!}">
                                        <span class="font-size-h3 symbol-label font-weight-boldest">{{ strtoupper(substr($ticket->agency->customer->name, 0, 4)) }}...</span>
                                    </div>
                                </div>
                                <!--end::Pic-->
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                        ...
                                        <div class="mr-3">
                                            <!--begin::Name-->
                                            <a href="{{ route('ticket.edit', ['id' => $ticket->id]) }}" class="d-flex align-items-center text-dark text-hover-primary font-size-h3 font-weight-bolder mr-3">
                                                {{ strtoupper($ticket->machine->model) }} <span class="text-muted text-hover-primary font-size-lg pl-3"> {{ strtoupper($ticket->machine->serialNumber) }}</span>
                                            </a>
                                            <!--end::Name-->
                                            <!--begin::Contacts-->
                                            <div class="d-flex flex-wrap my-2">
                                                <a href="#" class="text-dark text-hover-primary font-weight-bolder mr-lg-8 mr-5 mb-lg-0 mb-2" data-toggle="tooltip" title="{!! trans('Commercial who created this ticket is :name', ['name' => strtoupper($ticket->commercial->name)]) !!}" data-placement="top">
                                                <span class="svg-icon svg-icon-md svg-icon-gray-800 mr-1">
                                                    ...
                                                    {{ strtoupper($ticket->commercial->name) }}
                                                </a>
                                                <a href="{{ route('agency.edit', ['id' => $ticket->agency->id]) }}" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                                <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                    ...
                                                    {{ strtoupper($ticket->agency->designation) }}
                                                </a>
                                                ...
                                                <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                    ...
                                                    {{ strtoupper($ticket->agency->region->designation) }}
                                                </a>
                                            </div>
                                            <!--end::Contacts-->
                                        </div>
                                        ...
                                        <div class="my-lg-0 my-1">
                                            <a href="#" class="btn btn-link-dark btn-text-dark font-weight-bolder mr-5 " data-toggle="tooltip" title="{!! trans('Date: :date', ['date' => Carbon\Carbon::parse(intval(substr($ticket->planFor, 0, 10)))->format("d/m/Y H:i")]) !!}" data-placement="top">
                                                <span class="opacity-60 font-weight-bolder ml-2">
                                                    {{ Carbon\Carbon::parse(intval(substr($ticket->planFor, 0, 10)))->diffForHumans() }}
                                                </span>
                                            </a>
                                                ...
                                                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Status : NEW') }}" data-placement="top">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right p-0 m-0">
                                                        ...
                                                        <ul class="navi navi-hover py-3">
                                                            <li class="navi-item">
                                                                <a href="{{ route('ticket.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'QUEUED']) }}" class="navi-link px-5 font-weight-bold">
                                                                    <span class="navi-text">{{ __('QUEUED') }}</span>
                                                                </a>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="{{ route('ticket.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'INPROG']) }}" class="navi-link px-5 font-weight-bold">
                                                                    <span class="navi-text">{{ __('IN PROGRESS') }}</span>
                                                                </a>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="{{ route('ticket.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'PENDING']) }}" class="navi-link px-5 font-weight-bold">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="{{ route('ticket.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'RESOLVED']) }}" class="navi-link px-5 font-weight-bold">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="{{ route('ticket.status.update', ['id' => $ticket->id, 'code' => $ticket->code, 'newStatus' => 'CLOSED']) }}" class="navi-link px-5 font-weight-bold">
...
{{--            DISABLED TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_6" role="tabpanel" aria-labelledby="kt_tab_table_4_6">
                @forelse($listOfDisabledTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            NEW TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_5" role="tabpanel" aria-labelledby="kt_tab_table_4_5">
                @forelse($listOfNewTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            QUEUED TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_4" role="tabpanel" aria-labelledby="kt_tab_table_4_4">
                @forelse($listOfQueuedTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            IN PROGRESS TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_3" role="tabpanel" aria-labelledby="kt_tab_table_4_3">
                @forelse($listOfInProgressTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            PENDING TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_2" role="tabpanel" aria-labelledby="kt_tab_table_4_2">
                @forelse($listOfPendingTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            RESOLVED TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_1" role="tabpanel" aria-labelledby="kt_tab_table_4_1">
                @forelse($listOfResolvedTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
...
{{--            CLOSED TICKETS--}}
            <div class="tab-pane fade" id="kt_tab_table_4_0" role="tabpanel" aria-labelledby="kt_tab_table_4_0">
                @forelse($listOfClosedTickets as $ticket)
                    <!--begin::Card-->
                    <div class="card card-custom @if(!$loop->last) gutter-b @endif">
                        <div class="card-body">
                            <!--begin::Top-->
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                ...
                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                    ...
                    <tbody>
                        @foreach($listTotalOfTickets as $ticket)
                            <tr>
                                <td><span class="font-weight-bolder">#{{ $ticket->id }}</span></td>

                                <td>{{ strtoupper($ticket->code) }}</td>
                                <td>{{ ucfirst($ticket->machine->model) }}</td>
                                <td>{{ strtoupper($ticket->machine->serialNumber) }}</td>
                                <td>{{ strtoupper($ticket->commercial->name) }}</td>
                                <td>{{ strtoupper($ticket->agency->region->designation) }}</td>
                                <td>{!! trans(':number', ['number' => Carbon\Carbon::parse(intval(substr($ticket->planFor, 0, 10)))->format("d/m/Y")]) !!}</td>
                                <td>
                                    <ul>
                                        @foreach($ticket->technicians as $technician)
                                ...
                                <td class="p-0">
                                    <div class="text-right">
                                        <a href="{{ route('ticket.edit', ['id' => $ticket->id]) }}" class="btn btn-icon btn-light-primary m-1">
                                        ...
                                        @if(!$ticket->deletedAt)
                                            <a href="{{ route('ticket.disable.id', ['id' => $ticket->id, 'code' => $ticket->code]) }}" onclick="return confirm('{{ __('commercial-tickets.infos.ticket-are-you-sure-disable', ['code' => $ticket->code]) }}')" class="btn btn-icon btn-danger m-1">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-21-040700/theme/demo6/dist/../src/media/svg/icons/Home/Trash.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
